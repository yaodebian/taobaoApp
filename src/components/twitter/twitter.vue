<template>
  <div class="twitter-box">
    ...
    <div class="twitter-body">
      <div class="twitter-item" v-for="(item, index) in twitters" :key="index">
...
.twitter-item-attention {
    border-radius: 20%/50%;
    width: 2rem;
    background: linear-gradient(to right, #ff9900, #ff2f00) !important;
    color: #fff;
}
