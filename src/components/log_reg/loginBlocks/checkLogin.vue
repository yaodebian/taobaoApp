...
import checkLogin from "../../../asset/js/componentJs/logReg/login/checkLogin.js";
export default {
  name: "checkLogin",
  data() {
    return {};
  ...
  methods: {
    getLoginCode: checkLogin.getLoginCode,
    loginCodeOperate: checkLogin.loginCodeOperate
  }
};
</script>